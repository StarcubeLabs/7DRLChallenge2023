Shader "7DRL/7DRL_EmissiveSnapTexturedGrid"
{
    Properties
    {
        _MainTex ("Texture", 2D) = "white" {}
        _GridOverlay("Grid Overlay Texture", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                fixed4 grid = tex2D(_GridOverlay, i.uv);
                float alpha = col.a;
                // apply fog
                ...
                fin = lerp(fin * _ColorTint, grid, grid);
